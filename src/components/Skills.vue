<template>
  <section id="skills" class="section-padding py-20 relative">
    ...
    <div class="absolute inset-0 overflow-visible">
      <div
        class="floating-circle bg-primary/5 w-64 h-64 rounded-full absolute -top-20 -left-20"
      ></div>
      <div
        class="floating-circle-reverse bg-secondary/5 w-96 h-96 rounded-full absolute -bottom-32 -right-32"
      ></div>
    </div>

    <div class="text-center">
      <h2
        class="text-2xl sm:text-3xl md:text-4xl font-bold mb-8 sm:mb-12 heading-gradient"
      >
        Minhas Habilidades
      </h2>
      ...
      <div
        class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 sm:gap-8 max-w-6xl mx-auto px-4"
      >
        <div
...
const skills = [
  ...
  {
    name: "PHP",
    icon: new URL("../assets/php.svg", import.meta.url).href,
    useFA: false,
    isImage: true,
  },
  {
    name: "MySQL",
    icon: new URL("../assets/mysql.svg", import.meta.url).href,
    useFA: false,
    isImage: true,
  },
  {
    name: "Firebird",
    icon: new URL("../assets/firebird.svg", import.meta.url).href,
    useFA: false,
    isImage: true,
  },
];
...
const getSkillDescription = (skillName) => {
  const descriptions = {
    ...
    PHP: "Desenvolvimento back-end e aplicações web dinâmicas",
    MySQL: "Gerenciamento de banco de dados relacional",
    Firebird: "Banco de dados SQL robusto e de alta performance",
  };
